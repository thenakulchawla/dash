...
# ./dashd -regtest -daemon -debug -use-raptor=1 -port=8333 -rpcport=8332 -datadir=/home/nchawla3/.dashcore_data_2 -connect=127.0.0.1:8330 -conf=/home/nchawla3/dash/dash.conf
